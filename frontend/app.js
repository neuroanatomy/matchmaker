...
// Each steps/*.js module imports renderStep (and sometimes other helpers) back
// from this file, so this module and every steps/*.js module mutually import
// each other. This is deliberate, not a bug: every cross-import is only ever
// invoked from inside an event-handler closure, long after module evaluation
// completes, so there is no temporal-dead-zone hazard. See docs/30 for the
// full rationale.
